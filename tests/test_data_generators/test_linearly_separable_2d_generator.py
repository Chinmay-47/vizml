...
from vizml.data_generator import LinearlySeparable2DGenerator
...
def test_same_intial_generation(no_of_points):
    ...
    a = LinearlySeparable2DGenerator().generate(no_of_points=no_of_points)
    b = LinearlySeparable2DGenerator().generate(no_of_points=no_of_points)
...
def test_setting_seed():
    ...
    gen = LinearlySeparable2DGenerator()
...
def test_randomized_init_seed():
    ...
    b = LinearlySeparable2DGenerator(random=True)
...
def test_randomized_init_generation(no_of_points):
    ...
    a = LinearlySeparable2DGenerator().generate(no_of_points=no_of_points)
    b = LinearlySeparable2DGenerator(random=True).generate(no_of_points=no_of_points)
...
def test_same_random_state_gen_value():
    ...
    a = LinearlySeparable2DGenerator(random_state=7).generate()
    b = LinearlySeparable2DGenerator(random_state=7).generate()
...
def test_diff_random_state_gen_value():
    ...
    a = LinearlySeparable2DGenerator(random_state=7).generate()
    b = LinearlySeparable2DGenerator(random_state=11).generate()
