...
from vizml.data_generator import Normal3DGenerator
...
def test_same_intial_generation(no_of_points):
    ...
    b = Normal3DGenerator().generate(no_of_points=no_of_points)
...
def test_same_random_state_gen_value():
    ...
    a = Normal3DGenerator(random_state=7).generate()
    b = Normal3DGenerator(random_state=7).generate()
...
def test_diff_random_state_gen_value():
    ...
    a = Normal3DGenerator(random_state=7).generate()
    b = Normal3DGenerator(random_state=11).generate()
