...
from vizml.data_generator import MoonData2DGenerator
...
def test_same_intial_generation(no_of_points):
    ...
    a = MoonData2DGenerator().generate(no_of_points=no_of_points)
    b = MoonData2DGenerator().generate(no_of_points=no_of_points)
...
def test_randomized_init_seed():
    ...
    b = MoonData2DGenerator(random=True)
...
def test_randomized_init_generation(no_of_points):
    ...
    a = MoonData2DGenerator().generate(no_of_points=no_of_points)
    b = MoonData2DGenerator(random=True).generate(no_of_points=no_of_points)
...
def test_same_random_state_gen_value():
    ...
    a = MoonData2DGenerator(random_state=7).generate()
    b = MoonData2DGenerator(random_state=7).generate()
...
def test_diff_random_state_gen_value():
    ...
    a = MoonData2DGenerator(random_state=7).generate()
    b = MoonData2DGenerator(random_state=11).generate()
