...
def test_same_intial_generation(no_of_points):
    ...
    a = CircleDataGenerator().generate(no_of_points=no_of_points)
    b = CircleDataGenerator().generate(no_of_points=no_of_points)
...
def test_randomized_init_seed():
    ...
    b = CircleDataGenerator(random=True)
...
def test_randomized_init_generation(no_of_points):
    ...
    a = CircleDataGenerator().generate(no_of_points=no_of_points)
    b = CircleDataGenerator(random=True).generate(no_of_points=no_of_points)
...
def test_same_random_state_gen_value():
    ...
    a = CircleDataGenerator(random_state=7).generate()
    b = CircleDataGenerator(random_state=7).generate()
...
def test_diff_random_state_gen_value():
    ...
    a = CircleDataGenerator(random_state=7).generate()
    b = CircleDataGenerator(random_state=11).generate()
