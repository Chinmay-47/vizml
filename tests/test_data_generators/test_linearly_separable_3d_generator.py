...
from vizml.data_generator import LinearlySeparable3DGenerator
...
def test_same_intial_generation(no_of_points):
    ...
    a = LinearlySeparable3DGenerator().generate(no_of_points=no_of_points)
    b = LinearlySeparable3DGenerator().generate(no_of_points=no_of_points)
...
def test_setting_seed():
    ...
    gen = LinearlySeparable3DGenerator()
...
def test_randomized_init_seed():
    ...
    b = LinearlySeparable3DGenerator(random=True)
...
def test_randomized_init_generation(no_of_points):
    ...
    a = LinearlySeparable3DGenerator().generate(no_of_points=no_of_points)
    b = LinearlySeparable3DGenerator(random=True).generate(no_of_points=no_of_points)
...
def test_same_random_state_gen_value():
    ...
    a = LinearlySeparable3DGenerator(random_state=7).generate()
    b = LinearlySeparable3DGenerator(random_state=7).generate()
...
def test_diff_random_state_gen_value():
    ...
    a = LinearlySeparable3DGenerator(random_state=7).generate()
    b = LinearlySeparable3DGenerator(random_state=11).generate()
