...
polynomial_regression_visualizer = dash.Dash(name="polynomial_regression")

polynomial_regression_visualizer.layout = html.Div([
...
@polynomial_regression_visualizer.callback(
...
def init_regressor(random_state, num_points, is_lin_inc, degree):
